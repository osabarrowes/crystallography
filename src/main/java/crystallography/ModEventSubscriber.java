 ...
 */
@Mod.EventBusSubscriber(modid = Crystallography.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class ModEventSubscriber {

    private static final Logger LOGGER = LogManager.getLogger(Crystallography.MOD_ID + " Mod Event Subscriber");
    ...
    public static <T extends IForgeRegistryEntry<T>> T setup(final T entry, final String name) {
        return setup(entry, new ResourceLocation(Crystallography.MOD_ID, name));
    }
